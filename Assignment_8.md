...
-   For this assignment the use of AI tools (e.g., chatGPT, Microsoft
    ...
    -   **Academic integrity with AI:**, AI tools may be used for
        brainstorming, debugging, documentation support, and code
        review. Document AI interactions in an **“AI Use Log”** section,
        including prompts and a 1–2 sentence reflection on what changed
        in the work. Do not paste full solutions generated by AI without
        understanding and revising them; explain why each change was
        made.

    -   **AI Use Log Template:** The Quarto file `AI_log.qmd` and the
        rendered markdown file `AI_log.md` should have the following
        sections.

        1.  Tool(s) used:
        2.  Prompt(s): paste exact prompt(s) used
        3.  AI output summary: brief summary, not full text
        4.  Edits made and rationale: what was changed, why, and what
            was learned
        5.  Verification: how correctness was checked (unit tests, small
            examples, benchmarks)

    -   Finally complete the **Reflection** section at the end of the
        assignment.
...
*m**a**s**s* = *a* × *l**e**n**g**t**h*<sup>*b*</sup>
